...
#<?php echo $styles['wrapperid']; ?> { position:relative; float: left; width:<?php echo ($styles['width'] != "auto") ? ((int) $styles['width'] - 0) . 'px' : 'auto'; ?>; background:<?php echo $styles['background']; ?>; padding:0 0 0 0; border:<?php echo $styles['border']; ?>; border-radius:5px; margin:0; display:none; }
...
#<?php echo $styles['wrapperi:']; ?> #image<?php echo $styles['wrapperrand']; ?> img { position:absolute; left:0; border:none; border-radius:5px; height:auto; }
